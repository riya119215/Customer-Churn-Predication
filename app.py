...
# Base directory of this script - use it to build absolute paths for data/model files
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

df_1 = pd.read_csv(os.path.join(BASE_DIR, "data", "first_telc.csv"))
q = ""
...
if __name__ == '__main__':
    # Run only when executed directly. Use debug=True while developing.
    app.run(debug=True)
